...
/*10) Print all the types uniquely */
...
/*13) Select those publisher IDs and number of books which have price between 15 to 25 and have 'It' in its name. Print only those which have count greater than 2. Also, sort the result in ascending order of count */
