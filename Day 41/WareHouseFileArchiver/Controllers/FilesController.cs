    ...
    public class FilesController : ControllerBase
    {
        ...
        private async Task<IActionResult> HandleScheduledUpload(UploadArchiveFileRequestDto request)
        {
            try
            {
                ...
                var subject = existingFile != null ? "📁 A File Version Was Updated" : "📁 A New File Was Scheduled";
                var message = $"""
            Hello,

            A file has just been {(existingFile != null ? "updated (new version added)" : "scheduled")} by {uploadedBy}.
